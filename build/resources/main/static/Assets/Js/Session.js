...
async function loadUser(){
    ...
    const request = await fetch('http://localhost:8080/users/email/' + localStorage.email,{
        method : 'GET',
        headers: {
...
async function loadOrders(){
    ...
    const request = await fetch('http://localhost:8080/orders/' + localStorage.usuarioId,{
        method : 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
async function eliminarUsuario(){
    ...
    const request = await fetch('http://localhost:8080/users/delete/' + localStorage.usuarioId,{
        method : 'DELETE',
        headers: {
            // 'Accept': 'application/json',
            // 'Content-Type': 'application/json',
